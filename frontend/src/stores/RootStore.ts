...
import { MultiProxyStore } from './MultiProxyStore';
...
export class RootStore {
  ...
  readonly multiProxy: MultiProxyStore;
  ...
  constructor() {
    ...
    this.multiProxy = new MultiProxyStore(this.api);
